...
// Ambil data barang masuk + join nama barang
$data = query("
...
<div class="flex flex-col md:flex-row md:justify-between md:items-center mb-4 gap-4">
    ...
    <a href="tambah.php" 
       class="bg-gradient-to-r from-teal-500 to-teal-500 text-white px-4 py-2 rounded-2xl shadow hover:from-green-600 hover:to-teal-500 transition text-center">
        + Barang Masuk
    </a>
</div>
...
<div class="mb-4 flex justify-center md:justify-start">
    <input 
        ...
        class="w-full md:w-1/3 px-4 py-2 border rounded-xl shadow-sm focus:ring focus:ring-green-300 transition"
        onkeyup="searchTable()"
    >
</div>
    ...
    <table id="dataTable" class="min-w-full table-auto border-collapse text-gray-800">
        <thead>
            <tr class="bg-gradient-to-r from-green-200 to-teal-200 text-gray-900">
                ...
                <th class="border px-4 py-2 text-left">Jumlah Masuk</th>
